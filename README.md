...
<p> Our study on the economic impact analysis of internet shutdowns in India revealed significant losses for Telecom Service Providers, E-Businesses, and citizens. Telecom Service Providers lost INR 454 crore in 2020, while E-Businesses lost INR 217 crore due to internet shutdowns. The highest loss was borne by citizens, totaling INR 47,065 crore in 2020.</p>
<p> To address the gaps in the current regulatory framework, the study recommends the establishment of an independent review committee, provision for public consultation, monetary compensation to affected citizens and businesses, and the creation of a redressal mechanism. These recommendations seek to balance the need for internet shutdowns with the protection of citizens' and businesses' rights. Overall, internet shutdowns in India have negative economic impacts, and regulatory intervention is necessary to mitigate these effects.</p>
...
<h3>Output:</h3>
<ul>
  <li>Total value of Digital Transaction Per Hour in affected States in 2020 = <strong>77 Cr</strong></li> <br>
...
<ul>
  <li>
    Total value of Digital Transaction Per Hour in affected States in 2020 = <br> Sum of Value of Transaction per Hour (Rs) in 2020 of each state = 77 Cr<br>
	<span style="color: green">4 - <b>77 Cr</b></span>  
  </li>
  <li>
    ...
    Total value of Digital Transaction Per Hour in affected States (in Rs) in 2020 * Hours of Internet Shutdown in 2020 * ratio of affected population to total internet users in affected states =<br>
	  77 Cr * 8,927 * (10.3/374.745) = 2.53 Billion USD (1 USD = 75 INR)<br><br></li>
    <span style="color: green"> Using 4 <br>
	    Result: <b>Rs. 2.53 Billion USD (or Rs. 189.75 Cr)</b> lost due to internet shutdown</span>
  </li>
</ul>
...
<ul>
  ...
  <li>Total Net GDP loss due to Internet Shutdown in 2020 = 
    ...
    = $ 1.25 Billion
    <br><br>
	  <span style="color: green">Using 5  <br> -  Result : <b>$1.25 Billion </b> </span>
  </li>
</ul>
